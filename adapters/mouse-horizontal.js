...
function horizontalMouseAdapter() {
...
horizontalMouseAdapter.getServicesConfig = function(adapterConfig) {
	console.log('horizontalMouseAdapter getServicesConfig', adapterConfig);
...
horizontalMouseAdapter.getDefaultState = getDefaultState;
module.exports = horizontalMouseAdapter;
