...
verticalMouseAdapter.getServicesConfig = function(adapterConfig) {
	console.log('verticalMouseAdapter getServicesConfig', adapterConfig);
...
verticalMouseAdapter.getDefaultState = getDefaultState;
module.exports = verticalMouseAdapter;
